...
Weapons4Life = ["Weapons4Life", Item_Dev_Sword5, Item_Dual_Katana, Item_LifelessEdge, Item_Astral_Dagger, Item_Rusty_Dagger]

Harmful_Vibes = ["Harmful Vibes",Item_Dev_Sword5 , Item_Dual_Katana, Item_LifelessEdge, Item_Goats_Horn, Item_Rusty_Dagger]
